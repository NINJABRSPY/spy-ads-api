...
def convert_and_merge():
    ...
    for c in fm.get("creators", []):
        ...
        creator = {
            ...
            # Detail data (enriched)
            "mcn": c.get("_detail_base", {}).get("mcn", ""),
            "selling_categories": c.get("_detail_base", {}).get("selling_categories", []),
            "first_video_date": c.get("_detail_base", {}).get("first_video", ""),
            "region_rank": c.get("_detail_index", {}).get("region_rank", 0),
            "category_rank": c.get("_detail_index", {}).get("category_rank", 0),
            "flow_index": c.get("_detail_index", {}).get("flow_index", 0),
            "carry_index": c.get("_detail_index", {}).get("carry_index", 0),
            "new_followers_28d": c.get("_detail_index", {}).get("new_followers_28d", 0),
            "avg_video_views": c.get("_detail_index", {}).get("avg_video_views", 0),
            "avg_live_gmv": c.get("_detail_index", {}).get("avg_live_gmv", 0),
            "total_gmv": c.get("_detail_stats", {}).get("total_gmv", 0),
            "video_gmv": c.get("_detail_stats", {}).get("video_gmv", 0),
            "live_gmv": c.get("_detail_stats", {}).get("live_gmv", 0),
            "country_gmv_rank": c.get("_detail_stats", {}).get("country_rank", 0),
            "total_video_views": c.get("_detail_stats", {}).get("total_views", 0),
            "avg_engagement_rate": c.get("_detail_stats", {}).get("avg_engagement_rate", ""),
            "live_count": c.get("_detail_stats", {}).get("live_count", 0),
            "live_avg_viewers": c.get("_detail_stats", {}).get("live_avg_viewers", 0),
            "live_peak_viewers": c.get("_detail_stats", {}).get("live_peak_viewers", 0),
            "video_gpm": c.get("_detail_stats", {}).get("video_gpm", 0),
            "live_gpm": c.get("_detail_stats", {}).get("live_gpm", 0),
            "data_source": "fastmoss",
        }
